...
purchasing as (
      select 
        ...
        ,edi850.list_item_name      as edi_850 --,vendor.edi_850_id
        ,edi860.list_item_name      as edi_860 --,vendor.edi_860_id
        ,edi855.list_item_name      as edi_855 --,vendor.edi_855_id
        ,edi856.list_item_name      as edi_856 --,vendor.edi_856_id
        ,edi810.list_item_name      as edi_810 --,vendor.edi_810_id
        ,edi846.list_item_name      as edi_846 --,vendor.edi_846_id
        ,vendor.edi_capable
        ,vendor.creditlimit
    ...
    left join
      netsuite_vendor_asn.edi_document_type_status edi850 ON edi850.list_id=edi_850_id   --list_item_nameLIST_ITEM_NAME (list_id)
    left join
